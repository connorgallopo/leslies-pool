...
1. Click install.
1. In the HA UI go to "Configuration" -> "Integrations" click "+" and search for "leslies_pool".
...
[license]: https://github.com/connorgallopo/leslies-pool/blob/main/LICENSE
